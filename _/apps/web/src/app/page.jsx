          ...
          {productosLoading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {productos.map((producto) => (
                ...
                >
                  <div className="relative p-6 bg-gradient-to-br from-gray-50 to-blue-50 h-48 flex items-center justify-center">
                ...
                {cart.length === 0 ? (
                  ...
                  <div className="space-y-4">
                    {cart.map((item) => (
                      ...
                      >
                        <div className="flex-shrink-0 w-16 h-16 bg-gradient-to-br from-gray-50 to-blue-50 rounded-xl flex items-center justify-center">
              ...
              {cart.length > 0 && (
                <div className="p-6 border-t border-gray-200 bg-gray-50">
                  ...
                  <button
                    ...
                    className="w-full bg-green-600 text-white px-6 py-4 rounded-xl hover:bg-green-700 transition-colors font-medium flex items-center justify-center space-x-2 shadow-lg"
                  >
